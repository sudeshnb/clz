...
class TwoRotatingArc extends StatefulWidget {
  final double size;
  final Color color;
  const TwoRotatingArc({super.key, required this.color, required this.size});
          ...
          children: <Widget>[
            Visibility(
              ...
              child: Transform.rotate(
                angle: Tween<double>(begin: 0.0, end: 3 * math.pi / 4)
                    .animate(
                      CurvedAnimation(
            ...
            Visibility(
              visible: _animationController.value >= 0.5,
              child: Transform.rotate(
                angle: Tween<double>(begin: math.pi / 4, end: math.pi)
                    .animate(
                      CurvedAnimation(
                        parent: _animationController,
            ...
            Visibility(
              visible: _animationController.value >= 0.5,
              child: Transform.rotate(
                angle: Tween<double>(begin: -3 * math.pi / 4, end: 0.0)
                    .animate(
                      CurvedAnimation(
                        parent: _animationController,
                        curve: Interval(0.5, 1.0, curve: secondCurve),
